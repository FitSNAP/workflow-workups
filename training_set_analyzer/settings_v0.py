...
example_path = "./examples/InP_JCPA2020"
training_set_path = f"{example_path}/JSON"
settings_file_or_dict = f"{example_path}/InP-example.in"
user_label = "InP-example"
output_path = f"{example_path}/analysis_{user_label}"
